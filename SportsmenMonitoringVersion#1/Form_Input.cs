...
namespace Sportsmen_Monitoring
{
    public partial class Form_Input : Form
    {
        ...
        private void disciplinesCB_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                newGoal_CB.Items.Add(new ComboBoxItem { Text = a.Description == null ? a.Discipline.Name + " - " + a.Value + a.Discipline.Scale.Name : a.Description, Id = a.ID});
            }
        ...
        private void button_GoGraph_Click_1(object sender, EventArgs e)
        {
            var form = new Graphic();
            Hide();
            form.ShowDialog();
